...
class DocumentSyncStatusWithDetails(BaseModel):
    doc_id: str
    document_name: str
    ...
    @classmethod
    def from_model(cls, doc: DbDocument) -> "DocumentSyncStatusWithDetails":
        return DocumentSyncStatusWithDetails(
            doc_id=doc.id,
            document_name=doc.semantic_id,
